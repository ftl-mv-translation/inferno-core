...
local sysCdAugBox = augBox:New {
  Render = function(self,shipId,alpha)
    Graphics.CSurface.GL_RenderPrimitiveWithAlpha(self.boxPrimitive,alpha or 1)
    Graphics.freetype.easy_print(0,35,9,string.format("%g ион", (self.baseValue - Hyperspace.ships(shipId):GetAugmentationValue(self.augName))))
  end
}
  ...
  augBox:New {
    ...
    Render = function(self,shipId,alpha)
      ...
      Graphics.freetype.easy_print(
        ...
        35, 
        9, 
        string.format("%.3gс/ион", (self.baseValue/(1+Hyperspace.ships(shipId):GetAugmentationValue(self.augName))))
      )
    end,
  },
  sysCdAugBox:New {
